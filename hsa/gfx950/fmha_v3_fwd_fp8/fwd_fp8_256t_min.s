...
.text
.globl _ZN5aiter14fwd_fp8_256tminE
.p2align 8
.type _ZN5aiter14fwd_fp8_256tminE,@function

_ZN5aiter14fwd_fp8_256tminE:
    s_mov_b64 exec, -1
    
    // ========================================================================
    // 256T: Extract wave_id, only wave 0 computes
    // ========================================================================
    ...
    s_cbranch_execz END_KERNEL            // Skip if not wave 0
...
.rodata
.p2align 6
.amdhsa_kernel _ZN5aiter14fwd_fp8_256tminE
...
amdhsa.version: [1, 2]
amdhsa.kernels:
  - .name: _ZN5aiter14fwd_fp8_256tminE
    .symbol: _ZN5aiter14fwd_fp8_256tminE.kd
