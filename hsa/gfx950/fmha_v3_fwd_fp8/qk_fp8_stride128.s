// FP8 QK MFMA with stride-128 LDS layout (NAIVE - has bank conflicts)
// For comparison with stride-132 (zero conflicts)

.amdgcn_target "amdgcn-amd-amdhsa--gfx950"

.set LDS_STRIDE, 128         // Naive stride - causes bank conflicts!
.set HD, 128
.set Q_LDS_BASE, 0
.set K_LDS_BASE, 4096        // 32 * 128

.text
.globl _ZN5aiter15qk_fp8_stride128E
.p2align 8
.type _ZN5aiter15qk_fp8_stride128E,@function

_ZN5aiter15qk_fp8_stride128E:
    s_mov_b64 exec, -1
    ...
    v_cndmask_b32_e32 v62, v62, v4, vcc
    
    // Stride 128 addresses
...
.rodata
.p2align 6
.amdhsa_kernel _ZN5aiter15qk_fp8_stride128E
...
amdhsa.version: [1, 2]
amdhsa.kernels:
  - .name: _ZN5aiter15qk_fp8_stride128E
    .symbol: _ZN5aiter15qk_fp8_stride128E.kd
