...
def main():
    ...
    v_read_v3_add = int(os.environ.get("SCAFFOLD_V_READ_V3_ADD", "0"), 0)
    v_read_v4_add = int(os.environ.get("SCAFFOLD_V_READ_V4_ADD", "0"), 0)
    v_read_v2_add = int(os.environ.get("SCAFFOLD_V_READ_V2_ADD", "0"), 0)
    v_read_base_add = int(os.environ.get("SCAFFOLD_V_READ_BASE_ADD", "0"), 0)
    v_read_base_xor = int(os.environ.get("SCAFFOLD_V_READ_BASE_XOR", "0"), 0)
    v_read_base_extra_add = int(os.environ.get("SCAFFOLD_V_READ_BASE_EXTRA_ADD", "0"), 0)
    v_read_s25_override = int(os.environ.get("SCAFFOLD_V_READ_S25_OVERRIDE", "0"), 0)
