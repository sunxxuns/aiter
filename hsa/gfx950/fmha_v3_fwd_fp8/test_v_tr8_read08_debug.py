...
def build_kernel():
    ...
    src = f"{base_dir}/fwd_fp8_v_tr8_read08_debug.s"
    obj = f"{base_dir}/fwd_fp8_v_tr8_read08_debug.o"
    co = f"{base_dir}/fwd_fp8_v_tr8_read08_debug.co"
    cmd = (
...
def main():
    ...
    out = torch.zeros(2, device="cuda", dtype=torch.uint32)

    co = build_kernel()
    hip, module, func = load_kernel(co, "_fwd_fp8_v_tr8_read08_debug")
    args = [
